...
from utils.views import WebsiteDataListAPIView, WesiteDataDetailAPIView, WebsiteDataLabelsAPIView, WebisteCreateContactAPIView, WebsiteCreateLatestContactAPIView, ForexListAPIView
urlpatterns = [
